...
<body>
	...
	var		: 아래에서 반복으로 구분자로 인해 끊어지 값을 하나씩 변수명에 담아 출력하기 위해 설정하는 변수명
	...
	<!-- 햄버거~피자~오렌지~치킨~파스타~냉면~라면~    food 변수명에 담아서 구분자 기준으로 출력 
	HelloController /api/food 이름으로 fortokens 출력
	-->
	<c:forTokens var="food" items="햄버거~피자~오렌지~치킨~파스타~냉면~라면" delims="~">
		<li>${food}</li>
	</c:forTokens>
</body>
</html>